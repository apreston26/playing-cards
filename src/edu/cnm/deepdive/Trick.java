...
public class Trick {
  ...
  public static final String PILE_REPORT_FORMAT = "%1$s pile contents: %2$s; %1$s card count: %3$d.%n";
  ...
  private void report() {
    ...
    // The number followed by a dollar sign means argument 1 for 1$ and same thing with other numbers.
